...
const STATUS_OPTIONS = [
  { value: BeneficioEffectiveStatus.ACTIVO, label: "Activo" },
  { value: BeneficioEffectiveStatus.VENCIDO, label: "Vencido" },
  { value: BeneficioEffectiveStatus.AGOTADO, label: "Agotado" },
  { value: BeneficioEffectiveStatus.ELIMINADO, label: "Eliminado" },
] as const;
...
export default function DashboardFilters() {
  ...
  const controls = (
    <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
      ...
      <button
        ...
        className={cn(toggle(currentSoloHoy), "w-full sm:w-auto")}
      >
        Disponible hoy
      </button>
  ...
  return (
    <div className="mb-4 sm:mb-5 lg:mb-4 2xl:mb-5">
